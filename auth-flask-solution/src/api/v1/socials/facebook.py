...
def auth_facebook():
    ...
    account = AuthService.get_user_social(social_id=social_id, social_name='facebook')
    if not account:
        account = get_auth_service().create_oauth_user(email=email, social_id=social_id, social_name='facebook')
